...
const SystemeDocumentairePage = () => {
  return (
    <section className="container">
      ...
      <p className="mb-2">
        Pour atteindre ces objectifs, nous nous engageons à mettre en œuvre les
        actions nécessaires, en fournissant aux services les moyens humains et
      ...
      <p className="mb-2">
        ...
        des finances et des recettes municipales. Le système suit les exigences
        du référentiel MARHBA portant sur les chapitres :
      </p>
      ...
      <p className="mb-2">
        Les procédures de management traduit la stratégie de la DGCPR pour la
      ...
      <ul className="pl-14 list-disc mb-2">
        ...
        <li>
          Procédure maîtrise des documents et des enregistrements relatifs à la
          qualité PRD.01 (lien)
        </li>
      </ul>
      {/* TODO: image PDCA */}
      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th className="text-start border-2 border-foreground">Procédure </th>
          </tr>
        </thead>
        <tbody>
      ...
      <h4 className="my-4 text-lg font-medium text-red-800">Dépliants (sous onglet) ( voir site Jibaya la même template)</h4>
...
const procedureEtCode = [
  ...
  {
    code: "PRD.13",
    procedure: "Procédure gestion des suggestions et des réclamations des clients"
  },
  {
    code: "PRD.14",
    procedure: "Procédure collecte et suivi des indicateurs clés de performances"
  },
  {
    code: "PRD.15",
    procedure: "Procédure mesure et suivi de la satisfaction et des suggestions des clients"
  },
  {
    code: "PRD.18",
